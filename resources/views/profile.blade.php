...
@section('content')
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="" name="" value="{{ Universe::siswa()->nama_siswa }}" readonly="" id=""
                                        class="form-control">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="" name="" value="{{ Universe::siswa()->kelas->nama_kelas }}" readonly=""
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="" name="" value="{{ Universe::siswa()->nisn }}" readonly="" id=""
                                        class="form-control">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="" name="" value="{{ Universe::siswa()->nis }}" readonly="" id=""
                                        class="form-control">
                                </div>
                            </div>
                            <div class="col-lg-6">
    ...
    <div class="col-lg-7">
        <div class="callout callout-danger">
            <h5>Pemberitahuan!</h5>
            <p>Password default / Password bawaan dari WEB SPP SMK IDN adalah : <b>spp12345678</b></p>
        </div>
    </div>

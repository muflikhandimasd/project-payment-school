...
<style>
    .bg-side {
        ...
        background: rgb(37, 117, 195);
        background: linear-gradient(90deg, rgba(37, 117, 195, 1) 17%, rgba(100, 157, 213, 1) 100%);
    }
...
<aside class="main-sidebar bg-side sidebar-dark-primary">
    <!-- Brand Logo -->
    <a href="" class="brand-link">
        <img src="{{ asset('templates/backend/AdminLTE-3.1.0') }}/dist/img/laravel.jpg" alt="AdminLTE Logo"
            class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light">SPP SMK IDN</span>
    </a>
